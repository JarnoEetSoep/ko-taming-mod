...
public abstract class MixinDolphinEntity extends LivingEntity implements TorporEntity {

    private int torpor = 0;
    private final int BASETORPOR = Main.getBaseTorporConfig().baseDolphinTorpor;

    protected MixinDolphinEntity(EntityType<? extends LivingEntity> entityType, World world) {
