...
public abstract class MixinDrownedEntity extends LivingEntity implements TorporEntity {

    private int torpor = 0;
    private final int BASETORPOR = Main.getBaseTorporConfig().baseDrownedTorpor;

    protected MixinDrownedEntity(EntityType<? extends LivingEntity> entityType, World world) {
