...
public abstract class MixinSilverfishEntity extends LivingEntity implements TorporEntity {

    private int torpor = 0;
    private final int BASETORPOR = Main.getBaseTorporConfig().baseSilverfishTorpor;

    protected MixinSilverfishEntity(EntityType<? extends LivingEntity> entityType, World world) {
